...
# example.com/rabbitmq-cluster-operator-bundle:$VERSION and example.com/rabbitmq-cluster-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/rabbitmq-cluster-operator
